...
def resume(request,id):
    ...
    p.drawString(230,810,pp.dob)
    p.drawString(230,800,pp.LinkedIn)
    p.drawString(230,800,pp.city)
    ...
    p.drawString(20,775,pp.objective_line1)
    p.drawString(20,775,pp.objective_achievements)
    ...
    p.setFont("Helvetica", 9)
    p.drawString(20,740,pp.educational_qualifications_1)
    p.drawString(20,730,pp.educational_qualifications_2)
    p.drawString(20,720,pp.educational_qualifications_3)
    p.drawString(20,710,pp.educational_qualifications_4)
    
    p.drawString(0,690,"Skills")
    p.setStrokeColor(colors.red)    
    p.line(0,685,500,685)
    p.setFont("Helvetica", 9)
    p.drawString(20,675,pp.experience_1)
    p.drawString(20,665,pp.experience_1)
    p.drawString(20,655,pp.experience_1)
    p.drawString(20,645,pp.experience_1)
    ...
    p.setFont("Helvetica", 9)
    p.drawString(20,610,pp.skills_1)
    p.drawString(20,600,pp.skills_2)
    p.drawString(20,610,pp.skills_3)
    p.drawString(20,600,pp.skills_4)
    ...
    p.setFont("Helvetica", 9)
    p.drawString(20,565,pp.hobbies_1)
    p.drawString(20,555,pp.hobbies_2)
    p.drawString(20,545,pp.hobbies_3)
    p.drawString(20,535,pp.hobbies_4)
